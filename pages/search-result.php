...
if (isset($_GET['query'])) {
    ...
    $str = "SELECT * FROM SHOP s WHERE s.NAME LIKE '$que' AND s.IS_QIOSK = 4";
...
<body style="background-color: white;">
    ...
    <div class="container small-text pt-4" id="section-top">
        ...
        $result_users = include($_SERVER['DOCUMENT_ROOT'] . '/gaspol_web/logics/search_users.php');
        ...
        ?>
            ...
            ?>
                <a href="tab3-profile?store_id=<?= $f_pin ?>&f_pin=<?= $fpin_self ?>">
                    <div class="row mb-3">
                        <div class="col-3 d-flex align-items-center justify-content-center">
    ...
    <div class="container small-text pt-4" id="section-profile">
        ...
        $result = include($_SERVER['DOCUMENT_ROOT'] . '/gaspol_web/logics/search_users.php');
    ...
    <div class="container small-text pt-4" id="section-shop">
        ...
        $result = include($_SERVER['DOCUMENT_ROOT'] . '/gaspol_web/logics/search_query.php');
        ...
        ?>
                <div class="row mb-3 d-none" onclick="openShopProfile('<?= $shop_code ?>');">
                    <div class="col-3 d-flex align-items-center justify-content-center">
                        <img class="logo-merchant" src="../images/<?= $shop_pic[0] ?>" height="50px" width="50px" style="object-fit: cover; object-position: center">
                    </div>
                    <div class="col-9 small-left-padding d-flex align-items-center">

  ...
  <div class="p-3 shadow-sm fixed-top" style="border-bottom: 1px solid #e4e4e4; background-color: white">
    <div class="row">
      ...
      <div class="col-8 ps-0 pt-1">
        <b id="news-lang" style="font-size: 14px"></b>
      </div>
      <div class="col-2">
        <img src="../assets/img/action_share.png" style="width: 30px; height: 30px" onclick="shareUrl('<?= $postData['LINK'] ?>');">
      </div>
    </div>
  </div>

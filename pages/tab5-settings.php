...
<body id="main-menu">
    ...
    <div class="text-center" style="margin-bottom: 80px">
        <small class="text-grey smallest-text"><small data-translate="tab5settings-14">Version</small> <small id="version-name">1.0.211026</small></small><br />
...
<script>
    ...
    function getVersionName(){
        if(window.Android){
            var vername = Android.getAppVersion();
            $("#version-name").html(vername+"");
        }
    }

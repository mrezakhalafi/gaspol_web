...
$products_final = include_once($_SERVER['DOCUMENT_ROOT'] . '/gaspol_web/logics/fetch_products_following.php');
...
?>
    ...
    <div class="row mt-5" id="empty-news">
        <div class="col-8 mx-auto text-center">
            <img class="empty-logo" src="../assets/img/empty-following.png">
            <h6 class="empty-title"><strong>Start following to receive feed</strong></h6>
            <p class="empty-subtitle">You haven't followed anyone yet.</p>
        </div>
    </div>

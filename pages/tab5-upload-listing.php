<?php
    ...
    $query = $dbconn->prepare("SELECT * FROM CATEGORY WHERE EDUCATIONAL = 5 ORDER BY ID DESC");
	$query->execute();
    ...
    <form action="../logics/tab5/insert_new_listing" method="POST" enctype="multipart/form-data">
        ...
        <div class="section-upload-listing-desc">
            ...
            <div class="row gx-0">
                <div class="col-12 col-md-12 col-lg-12 upload-listing">
                    <div class="form-check" style="padding-top: 5px; padding-bottom: 5px !important">
                        <input class="form-check-input" style="border:1px solid #6c6f74 !important" name="post_check_old" type="checkbox" value="1" id="flexCheckDefault" checked>
            ...
            <!-- <div class="row gx-0">
                <div class="col-12 col-md-12 col-lg-12 upload-listing">
                    <div class="form-check" style="padding-top: 5px; padding-bottom: 5px !important">
                        <input class="form-check-input" style="border:1px solid #6c6f74 !important" name="paid_content" type="checkbox" value="1" id="flexCheckDefaultPaid">

...
$store = include_once($_SERVER['DOCUMENT_ROOT'] . '/gaspol_web/logics/fetch_stores_raw.php');
...
if (substr($store_thumb_id, 0, 4) !== "http") {
  $store_thumb_id = "/gaspol_web/images/" . $store_thumb_id;
}
...
<body>
  ...
  <!-- <div id="header-layout" class="sticky-top">
    ...
    <img src="/gaspol_web/assets/img/idn_nature_<?php echo $rand_bg; ?>" style="display:none;" alt="" />
    <div class="profile-header jumbotron jumbotron-fluid mx-auto text-center" style="background-image:url(/gaspol_web/assets/img/idn_nature_<?php echo $rand_bg; ?>)">

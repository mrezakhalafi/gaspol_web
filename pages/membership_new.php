...
<html>
  ...
  <div class="fixed-top">
    <div class="pt-2 pb-4" style="background-color: #ffa500">
      <div class="row p-3">
        <div class="col-10">
          <h1 style="color: white; font-size: 14px"><b>Membership</b></h1>
        </div>
      ...
      <?php if (isset($checkKTA)): ?>
        ...
        <?php if (isset($checkKIS)): ?>
          ...
          <div class="card mx-3 p-2" style="background-color: #0b0b35">
            <div class="card-body">
              <div class="row gx-0">
                <div class="col-10">
                  <h5 style="font-size: 17px; margin-bottom: 0px"><b>IKATAN IMI INDONESIA</b></h5>
                  <p style="font-size: 13px; font-weight: 300" class="mt-1">Kartu Tanda Anggota - KIS</p>
                </div>
                <div class="col-2 text-end">
              ...
              <p class="clubs" style="font-size: 13px; font-weight: 300" class="mt-1"><?= $getClub['CLUB_NAME'] ?></p>
              <div class="row">
                <div class="col-6">
        ...
        <div class="card mx-3 p-2" style="background-color: #0b0b35">
          <div class="card-body">
            <div class="row gx-0">
              <div class="col-10">
                <h5 style="font-size: 17px; margin-bottom: 0px"><b>IKATAN IMI INDONESIA</b></h5>
                <p style="font-size: 13px; font-weight: 300" class="mt-1">Kartu Tanda Anggota - KTA Mobility</p>
              </div>
              <div class="col-2 text-end">
                <img src="../assets/img/logo-imi.png" style="width: 100px; height: auto; width: 60px; height: auto; margin-top: -10px">
              </div>
        ...
        <div class="card mx-3 p-2" style="background-color: #0b0b35">
          <div class="card-body">
            <div class="row gx-0">
              <div class="col-10">
                <h5 style="font-size: 17px; margin-bottom: 0px"><b>IKATAN IMI INDONESIA</b></h5>
                <p style="font-size: 13px; font-weight: 300" class="mt-1">Kartu Tanda Anggota - KTA Pro</p>
              </div>
              <div class="col-2 text-end">
                <img src="../assets/img/logo-imi.png" style="width: 100px; height: auto; width: 60px; height: auto; margin-top: -10px">
              </div>
    ...
    <?php else: ?>
      ...
      <?php 
        ...
        <div class="card mx-3 p-2" style="background-color: white">
          <div class="card-body">
            <div class="row gx-0">
              <div class="col-12 text-center">
                <h5 style="font-size: 17px; margin-bottom: 0px; color: black"><b>IKATAN IMI INDONESIA</b></h5>
              </div>
              <div class="row mt-4">
                <div class="col-12 text-center">
                  <img src="../assets/img/logo-imi.png" style="height: auto; width: 35px; height: auto">
                  <small style="color: grey; font-size: 11px">Member of</small>
            ...
            <div class="row gx-0 mt-3">
              <div class="col-6 text-center">
                <button onclick="upgradeMobility()" style="width: 80%; margin-top: 5px; font-weight: bold; background-color:#ff6700; border-radius: 20px; border: none; color: white; padding: 7px; font-size: 13px; padding-left: 15px; padding-right: 15px">Register KTA</button>
              </div>
              <div class="col-6 text-center">
                <button onclick="claimKTA()" style="width: 80%; margin-top: 5px; font-weight: bold; background-color:white; border-radius: 20px; border: 1px solid black; color: black; padding: 7px; font-size: 13px; padding-left: 15px; padding-right: 15px">Claim KTA</button>
              </div>
              <div class="row gx-0">
                <div class="col-12 text-center mt-2">
                  <small style="color: grey; font-size: 11px">Become IMI member to receive extraordinary benefits.</small>
                </div>
              </div>
            </div>
          </div>
  ...
  <div class="fixed-top section-menu bg-white shadow" style="margin-top: 268px">
    ...
    <div id="ktaMobility" class="slide-menu pt-3 px-4 <?php if ($_GET['m'] != 0): ?> d-none <?php endif; ?>" style="margin-top: 345px; margin-bottom: 100px">

      <div class="row">
        <div class="col-8">
          <b style="font-size: 16px">Mobility</b>
        </div>
        <div class="col-4">
      ...
      <div class="section-slide mt-3">
        <p style="font-size: 12px">Benefits</p>
        <div class="row pb-2 pt-2" style="border-bottom: 1px solid #eaeaea">
          <div class="col-2 text-center">
            <img src="../assets/img/social/globe.svg" style="width: 28px; height: 28px">
          </div>
          <div class="col-10">
            <b style="font-size: 13px">Wide range IMI Network</b><br />
            <small style="font-size: 11px; color: #646464">Become part of the largest automotive organization</small>
          </div>
        </div>
        <div class="row pb-2 pt-2" style="border-bottom: 1px solid #eaeaea">
          <div class="col-2 text-center">
        ...
        <div class="row pb-2 pt-2" style="border-bottom: 1px solid #eaeaea">
          ...
          <div class="col-10">
            ...
            <small style="font-size: 11px; color: #646464">Receive discount from IMI's official merchant</small>
          </div>
        </div>
        <div class="row pb-2 pt-2" style="border-bottom: 1px solid #eaeaea">
          <div class="col-2 text-center">
      ...
      <div class="section-slide mt-3">
        ...
        <div class="row pt-2 pb-2" style="border-bottom: 1px solid #eaeaea">
          ...
          <div class="col-10">
            ...
            <small style="font-size: 11px; color: #646464">Annual membership</small>
          </div>
        </div>
      </div>
    </div>
    ...
    <div id="ktaPro" class="slide-menu pt-3 px-4 <?php if ($_GET['m'] != 1): ?> d-none <?php endif; ?>" style="margin-top: 345px; margin-bottom: 100px">
      ...
      <div class="section-slide mt-3">
        ...
        <div class="row pt-2 pb-2" style="border-bottom: 1px solid #eaeaea">
          ...
          <div class="col-10">
            ...
            <small style="font-size: 11px; color: #646464">Federation Internationale de I'Automobile (FIA)</small>
          </div>
        </div>
        <div class="row pt-2 pb-2" style="border-bottom: 1px solid #eaeaea">
          <div class="col-2 text-center">
          ...
          <div class="col-10">
            ...
            <small style="font-size: 11px; color: #646464">Federation Internationale de Motorcyclisme (FIM)</small>
          </div>
        </div>
        <div class="row pt-2 pb-2" style="border-bottom: 1px solid #eaeaea">
          <div class="col-2 text-center">
      ...
      <div class="section-slide mt-3">
        ...
        <div class="row pt-2 pb-2" style="border-bottom: 1px solid #eaeaea">
          ...
          <div class="col-10">
            <b style="font-size: 13px">Fill out registration forms</b><br />
            <small style="font-size: 11px; color: #646464">Prepare your ID and upload then</small>
          </div>
        </div>
        <div class="row pt-2 pb-2" style="border-bottom: 1px solid #eaeaea">
          <div class="col-2 text-center">
          ...
          <div class="col-10">
            <b style="font-size: 13px">Joined a Club</b><br />
            <small style="font-size: 11px; color: #646464">You must be a member of a club</small>
          </div>
        </div>
        <div class="row pt-2 pb-2" style="border-bottom: 1px solid #eaeaea">
          <div class="col-2 text-center">
    ...
    <div id="kis" class="slide-menu pt-3 px-4 <?php if ($_GET['m'] != 2): ?> d-none <?php endif; ?>" style="margin-top: 345px; margin-bottom: 100px">
      ...
      <div class="section-slide mt-3">
        ...
        <div class="row pt-2 pb-2" style="border-bottom: 1px solid #eaeaea">
          ...
          <div class="col-10">
            <b style="font-size: 13px">KTA Pro Membership</b><br />
            <small style="font-size: 11px; color: #646464">Active KTA Pro membership</small>
          </div>
        </div>
        <div class="row pt-2 pb-2" style="border-bottom: 1px solid #eaeaea">
          <div class="col-2 text-center">
        ...
        <div class="row pt-2 pb-2" style="border-bottom: 1px solid #eaeaea">
          ...
          <div class="col-10">
            <b style="font-size: 13px">Pay Rp 250.000 fee</b><br />
            <small style="font-size: 11px; color: #646464">Annual membership</small>
          </div>
        </div>
      </div>
...
<script>
  ...
  function ktaMobility(){
    ...
    // localStorage.setItem('menu_ls',0);
    // localStorage.setItem('menu_ls',2);
    let dest = 'menu_membership?f_pin=' + F_PIN + '&m=0';
  ...
  function ktaPro(){
    ...
    // localStorage.setItem('menu_ls',1);
    // localStorage.setItem('menu_ls',2);
    let dest = 'menu_membership?f_pin=' + F_PIN + '&m=1';
    window.history.replaceState(null, "", dest);
  ...
  function kis(){
    ...
    // localStorage.setItem('menu_ls',2);
    let dest = 'menu_membership?f_pin=' + F_PIN + '&m=2';
    window.history.replaceState(null, "", dest);

<?php
	...
	$query = $dbconn->prepare("SELECT * FROM USER_HIGHLIGHT WHERE F_PIN = '".$id_user."' AND IS_QIOSK = 4");
	$query->execute();
...
<body id="main-menu">
	...
	<!-- SECTION BUTTON -->
	<div class="section-button" style="border-top: 1px solid #d1d5db; margin-top: -29px">
		<div class="row">
			...
			<div class="col-6 col-md-6 col-lg-6 text-center">
				<a href="tab5-delivery-address.php">
					...
					<p class="small-text" data-translate="tab5-8">Delivery Address</p>
				</a>
			</div>
		</div>
	</div>

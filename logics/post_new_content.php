<?php 
    ...
    try {
        $upload_dir = $_SERVER['DOCUMENT_ROOT'] . 'gaspol_web/assets/uploads/';
        // $upload_dir = '/gaspol_web/assets/uploads/';
        $filenamelist = '';
        ...
        try {
            for($i = 0; $i < 5; $i++) {
                ...
                // $video_name = base_url() . '/gaspol_web/images/' . $video_name;
                ...
                try {
                    ...
                    // $thumb_name = $_SERVER['DOCUMENT_ROOT'] . 'gaspol_web/images/' . $thumb_name;
                    // $thumb_name = '/gaspol_web/images/' . $thumb_name;

...
$products = include_once($_SERVER['DOCUMENT_ROOT'] . '/gaspol_web/logics/fetch_products_raw.php');
...
// $stores = include_once($_SERVER['DOCUMENT_ROOT'] . '/gaspol_web/logics/fetch_stories_store.php');
// if (isset($_REQUEST['filter'])) {
//     $stores_final = array();
//     $filterArr = explode('-', $_REQUEST['filter']);

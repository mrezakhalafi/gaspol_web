<?php 
    ...
    try {
        $upload_dir = base_url() . 'gaspol_web/images/';
        ...
        $query = $dbconn->prepare(
            "INSERT INTO SHOP(`CODE`, `NAME`, `CREATED_DATE`, `DESCRIPTION`, `FILE_TYPE`, `THUMB_ID`, `LINK`, `CATEGORY`, `USE_ADBLOCK`, `CAN_DELETE`, `CREATED_BY`, `SHOW_FOLLOWS`, `IS_QIOSK`) VALUES (?, ?, ?, ?, 1, ?, ?, ?, ?, 1, ?, 0, 4)");

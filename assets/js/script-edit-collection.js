...
function fetchCollection (f_pin) {
    ...
    xmlHttp.open("get", "/gaspol_web/logics/fetch_collection?f_pin=" + f_pin);
    xmlHttp.send();
}
...
function changeVisibilityStatus(collection_code) {
    ...
    xmlHttp.open("post", "/gaspol_web/logics/change_collection_visibility");
...
function deleteCollection(collection_code) {
    ...
    $('#delete-collection-ok').click(function() {
        ...
        xmlHttp.open("post", "/gaspol_web/logics/delete_collection");
        xmlHttp.send(formData);
    })
}
...
function fetchPurchases(f_pin) {
    ...
    xmlHttp.open("get", "/gaspol_web/logics/fetch_purchases?f_pin=" + f_pin);
    xmlHttp.send();
}
